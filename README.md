...
│   ├── ai-assistant.png
│   ├── billing.png
│   ├── customers-managment.png
│   ├── dashboard.png
│   ├── inventory.png
│   ├── login.png
│   ├── paymentHistory.png
│   ├── products-managment.png
│   ├── purchases-managment.png
│   ├── reports.png
│   └── suppliers-managment.png
│
├── utils/
│   ├── email_sender.py
│   └── pdf_generator.py
...
The application has been packaged as a Windows desktop executable using PyInstaller.

The executable has been tested successfully with:
...
The current application uses a local MySQL database, which must be configured on the system where the application is used.
